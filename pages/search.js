      ...
      <div className="w-1/6 p-4 bg-[#ECF5FD] flex flex-col justify-between fixed h-full" style={{ fontFamily: 'Open Sans, sans-serif' }}>
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center">
            ...
            <a href="https://discord.gg/G66pESH3gm" target="_blank" rel="noopener noreferrer" className="text-xs ml-2 hover:text-blue-500 transition duration-300">Join our discord</a>
          </div>
        </div>
      </div>
