...
export default function Search() {
  ...
  const handleLayoutChange = useCallback((newLayout) => {
    ...
    if (knowledgeGraphData) {
      ...
      switch (newLayout) {
        case 'pyramid':
          newGraphData = createPyramidLayout(knowledgeGraphData.nodes, knowledgeGraphData.edges);
          break;
        case 'mindMap':
          newGraphData = createMindMapLayout(knowledgeGraphData.nodes, knowledgeGraphData.edges);
          break;
        case 'radialTree':
        default:
