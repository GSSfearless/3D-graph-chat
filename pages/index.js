        ...
        <div className="container mx-auto px-4 md:px-6 z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-center">
            ...
            <div className="lg:col-span-7 order-1 lg:order-2">
              <div className="relative rounded-2xl overflow-visible" style={{ height: "650px", maxHeight: "calc(100vh - 150px)" }}>
                {/* 确保给3D图谱足够的空间并加上明确的z-index */}
                <div className="absolute inset-0 z-10" style={{ overflow: 'visible', transform: 'scale(1.1)' }}>
