      ...
      <section className="relative min-h-screen flex items-center py-12 lg:py-16 overflow-hidden bg-white">
        ...
        <div className="container mx-auto px-4 md:px-6 z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-center">
            {/* 左侧：标题和介绍 */}
            <div className={`${isMobile ? 'order-2' : 'lg:col-span-5 order-2 lg:order-1'}`}>
              <div className="mb-4">
              ...
              <p className={`text-gray-600 ${isMobile ? 'text-base' : 'text-lg'} mb-8 max-w-lg leading-relaxed`}>
                突破传统平面限制，以沉浸式3D体验
                将复杂知识立体化展现，让思维触手可及
              </p>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg mb-8 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                <h2 className={`${isMobile ? 'text-lg' : 'text-xl'} font-semibold text-gray-800 mb-3`}>体验您自己的知识图谱</h2>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-white p-3 rounded-xl shadow-md text-center transform hover:scale-105 transition duration-300">
                  <div className={`${isMobile ? 'text-xl' : 'text-2xl'} font-bold text-blue-600`}>360°</div>
                  <div className="text-xs text-gray-500">立体可视化</div>
                </div>
                <div className="bg-white p-3 rounded-xl shadow-md text-center transform hover:scale-105 transition duration-300">
                  <div className={`${isMobile ? 'text-xl' : 'text-2xl'} font-bold text-indigo-600`}>98%</div>
                  <div className="text-xs text-gray-500">识别准确率</div>
                </div>
                <div className="bg-white p-3 rounded-xl shadow-md text-center transform hover:scale-105 transition duration-300">
                  <div className={`${isMobile ? 'text-xl' : 'text-2xl'} font-bold text-purple-600`}>1M+</div>
            ...
            <div className={`${isMobile ? 'order-1' : 'lg:col-span-7 order-1 lg:order-2'}`}>
              <div className="relative bg-gradient-to-br from-blue-50/80 to-indigo-50/80 rounded-2xl overflow-hidden shadow-xl border border-indigo-100" style={{ height: isMobile ? "400px" : "600px", maxHeight: "calc(100vh - 200px)" }}>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col items-center">
            ...
            <div className="grid md:grid-cols-3 gap-6 lg:gap-8 max-w-5xl mx-auto w-full">
              {/* 为移动设备调整的卡片布局 */}
              <div className={`${isMobile ? 'mb-6' : ''} bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-100 hover:border-gray-200`}>
                ...
                <h3 className={`${isMobile ? 'text-lg' : 'text-xl'} font-semibold mb-4`}>实体关系抽取</h3>
              ...
              <div className={`${isMobile ? 'mb-6' : ''} bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-100 hover:border-gray-200`}>
                ...
                <h3 className={`${isMobile ? 'text-lg' : 'text-xl'} font-semibold mb-4`}>3D立体图谱</h3>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-100 hover:border-gray-200">
                ...
                <h3 className={`${isMobile ? 'text-lg' : 'text-xl'} font-semibold mb-4`}>实时图谱生成</h3>
                <p className="text-gray-600 leading-relaxed">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-indigo-700 py-16">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto flex flex-col items-center text-center">
            ...
            <h2 className={`${isMobile ? 'text-2xl' : 'text-3xl md:text-4xl'} font-bold text-white mb-6`}>开始您的知识可视化之旅</h2>
            ...
            <div className={`flex ${isMobile ? 'flex-col w-full' : 'flex-col sm:flex-row gap-4 w-full max-w-md'} justify-center`}>
              <a
                href="/search"
