...
function Home({ defaultLang }) {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-[#f8f9fa] relative overflow-hidden">
      {/* Left side - Deep Think */}
      <div className="flex-1 flex flex-col items-center justify-center p-8 bg-gradient-to-br from-blue-500 to-blue-600 relative z-10">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8 bg-gradient-to-bl from-yellow-500 to-yellow-600 relative z-10">
      ...
      {/* Gradient overlay for center area */}
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-500 via-purple-500 to-yellow-500 opacity-50"></div>
      </div>

      {/* Centered search bar */}
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl px-4 z-20">
        <h1 className="text-4xl font-semibold mb-8 text-center text-white drop-shadow-lg">
          {getText('mainTitle')}
        </h1>
        <div className="bg-white/90 backdrop-blur-sm p-4 rounded-lg shadow-lg mb-4 flex items-center border border-white/20 transition-all duration-300 hover:bg-white hover:border-white hover:shadow-2xl" style={{ minHeight: '5rem' }}>
