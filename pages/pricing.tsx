  ...
  return (
    <Layout title="价格 - Think Graph" description="探索Think Graph的各种订阅计划，找到最适合您需求的选择">
      <div className="w-full">
        ...
        {/* FAQ部分 */}
        <section className="py-16 bg-gray-50 border-t border-gray-200 w-full">
          <div className="container mx-auto px-4 md:px-6">
        ...
        {/* CTA部分 */}
        <section className="py-16 bg-gradient-to-r from-blue-600 to-indigo-700 text-white w-full">
